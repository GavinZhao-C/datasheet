...
/***************************************************************************/
/* DEMO3231.C                                             
https://www.maximintegrated.com/cn/app-notes/index.mvp/id/3506

应用笔记3506	
DS3231与8051微控制器的接口

摘要：本应用笔记提供了一个DS3231与8051微控制器接口的硬件电路和软件例程。 

说明
本应用笔记介绍了DS3231与8051微控制器的连接方式，并提供了一个基本的接口程序。本文采用的微控制器是DS2250，软件用C语言编写。
